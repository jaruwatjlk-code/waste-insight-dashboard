...
export function Top10JobsChart({ rows, chartJobs, onClickJob }: Props) {
  ...
  const sorted = useMemo(() =>
    sortDir === 'desc' ? [...top10] : [...top10].reverse()
  , [top10, sortDir])
        ...
        <div className="flex-1 min-w-0">
          <ResponsiveContainer width="100%" height={top10.length * 30 + 24}>
            ...
            >
              ...
              <YAxis type="category" dataKey="jo" tick={{ fontSize: 9, fill: '#64748b' }} width={54} axisLine={false} tickLine={false}/>
          ...
          <table className="w-full text-xs">
              ...
              {sorted.map((r,i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="py-1.5 text-slate-700 max-w-[100px] truncate" title={r.comp}>{r.comp}</td>
            ...
            <tfoot>
              <tr className="border-t-2 border-slate-200 font-semibold text-slate-700">
                ...
                <td className="pt-2 text-right font-mono text-xs">
